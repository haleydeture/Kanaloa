...
#pragma once
  ...
  #define I2C_TIMEOUT 100 //Set time outs for lockups
  #define I2C_MAXWAIT 100 //Time outs for a different class I2C related lockups
...
void tcaselect(uint8_t i) {
  ...
  i2c_start_wait(TCAADDR);
  i2c_write(1 << i);
  i2c_stop();
}

/*Alter on NUC's version
  #pragma once
  #define SDA_PORT PORTD
  #define SDA_PIN 44 //Looking at the ports and microcontroller pins chart, this is digital pin 20
  #define SCL_PORT PORTD
