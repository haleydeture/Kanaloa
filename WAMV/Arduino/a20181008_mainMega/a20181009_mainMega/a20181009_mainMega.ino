...
#include <I2C.h>                // Timeouts for the multiplexer (less freezes)
#include "Adafruit_MCP4725_custom.h"  // customized Adafruit DAC library, must install and add "Adafruit_MCP4725_custom.h" (on Github daniel branch) library to your IDE to compile
